	...
	return []permissionParsingTestCase{
		{
			...
			expected: map[string]string{
				testPermissionContents: testPermissionRead,
				testPermissionIssues:   testPermissionWrite,
			},
			critical: true,
		},
		{
			...
			expected: map[string]string{
				testPermissionContents:           testPermissionRead,
				testPermissionIssues:             testPermissionWrite,
				testutil.TestFixturePullRequests: testPermissionRead,
			},
			critical: true,
		},
		{
			...
			expected: map[string]string{testPermissionContents: testPermissionRead},
			critical: true,
		},
		{
		...
		},
		{
			...
			expected: map[string]string{testPermissionContents: "read:write"},
			critical: true,
		},
		{
		...
		},
		{
			...
			expected: map[string]string{
				testPermissionActions:            testPermissionWrite,
				"attestations":                   testPermissionWrite,
				"checks":                         testPermissionWrite,
				testPermissionContents:           testPermissionWrite,
				"deployments":                    testPermissionWrite,
				"discussions":                    testPermissionWrite,
				"id-token":                       testPermissionWrite,
				testPermissionIssues:             testPermissionWrite,
				"packages":                       testPermissionWrite,
				"pages":                          testPermissionWrite,
				testutil.TestFixturePullRequests: testPermissionWrite,
				"repository-projects":            testPermissionWrite,
				"security-events":                testPermissionWrite,
				"statuses":                       testPermissionWrite,
			},
			critical: false,
		},
	}
...
func TestMergePermissionsMutationResistance(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			yamlPerms:    nil,
			commentPerms: map[string]string{testPermissionContents: testPermissionRead},
			expected:     map[string]string{testPermissionContents: testPermissionRead},
			critical:     true,
		...
		},
		{
			...
			yamlPerms:    map[string]string{testPermissionContents: testPermissionWrite},
			commentPerms: nil,
			expected:     map[string]string{testPermissionContents: testPermissionWrite},
			critical:     true,
		...
		},
		{
			...
			yamlPerms:    map[string]string{testPermissionContents: testPermissionWrite},
			commentPerms: map[string]string{testPermissionIssues: testPermissionRead},
			expected: map[string]string{
				testPermissionContents: testPermissionWrite,
				testPermissionIssues:   testPermissionRead,
			},
			critical:    true,
		...
		},
		{
			...
			expected: map[string]string{
				testPermissionContents:           testPermissionWrite, // YAML wins
				testPermissionIssues:             testPermissionWrite, // Only in YAML
				testutil.TestFixturePullRequests: testPermissionRead,  // Only in comment
			},
			critical:    true,
	...
	tests := []permissionLineTestCase{
		{
			...
			expectKey:   testPermissionContents,
			expectValue: testPermissionRead,
			expectOk:    true,
			critical:    true,
...
func TestProcessPermissionEntryMutationResistance(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			initialExpected:   -1,
			expectBreak:       false,
			expectPermissions: map[string]string{testPermissionContents: testPermissionRead},
			critical:          true,
		...
		},
		{
			...
			initialExpected:   3,
			expectBreak:       false,
			expectPermissions: map[string]string{testPermissionIssues: testPermissionWrite},
			critical:          true,
